...
namespace NFT.PageObject;

/// <summary>
/// A class represeting the Page Object Model.
/// </summary>
public class PageObject
{
    ...
    public async Task<IReadOnlyList<TodoPageItem>> GetItemsAsync()
    {
        ...
        return elements.Select(x => new PageObjectItem(x)).ToArray();
    }
    ...
    public sealed class PageObjectItem
    {
        internal PageObjectItem(IElementHandle item)
        {
            Item = item;
        }
